...
def render_test():
    ...
    return str(data["Res"]["Connections"]["Connection"][1]["Sections"]["Sec"][0]["Dep"]["Stn"]["name"]) + " to " + str(data["Res"]["Connections"]["Connection"][1]["Sections"]["Sec"][len(data["Res"]["Connections"]["Connection"][1]["Sections"]["Sec"]) - 1]["Dep"]["Stn"]["name"])
